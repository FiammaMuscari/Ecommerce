    ...
    <div className="container pt-5 pb-5 d-flex justify-content-center ">
        <div className="card mb-3 w-50  ">
          ...
          <div className="card-body">
            ...
            <p className="card-text display-6">Somos una empresa en constante expansión. Siempre interesados en mejorar el servicio, comuniquese con nosotros siempre que lo necesite estamos a su disposición.</p>
